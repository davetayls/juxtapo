...
(function(){
    ...
    juxtapo.designs = {
        back: function(){
            if (juxtapo.currentDesignView == juxtapo.designViews.hidden) {
                ...
                if (juxtapo.currentDesignView == juxtapo.designViews.semiTransparent) {
        ...
        init: function(){
            ...
            $('<img id="design" src="noimage.jpg" alt="design image" />').appendTo("body").css({
                display: 'none'
            });
            ...
            if (dv != null) {
                if (dv == juxtapo.designViews.hidden) {
                    ...
                    if (dv == juxtapo.designViews.semiTransparent) {
                        juxtapo.designs.semiTransparent();
                    }
                    else {
                        juxtapo.designs.show();
    ...
    juxtapo.designs.designTemplate.prototype = {
        ...
        _init: function(imageUrl, paths, settings){
	        ...
	        this.paths = paths;
	        this.settings.style = juxtapo.designs.designTemplate.defaultStyles;
	        this.settings = $.extend({}, juxtapo.designs.designTemplate.settings, settings);
        }
    };
