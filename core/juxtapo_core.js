...
(function() {
	...
	juxtapo = {
		...
		designLayoutImages : [], // list of layout images to place as the
									// design overlay
	...
	/**
	 * Adds a juxtapo.designs.LayoutTemplate object to the designLayoutImages
	 * array
	 * 
	 * @param {String}
	 *            imageUrl
	...
	juxtapo.onMouseMove = function() {
		...
		if (juxtapo.currentStatus == juxtapo.statuses.play) {
			juxtapo.timerId = setTimeout('juxtapo.control.reload()',
					juxtapo.secondsBeforeRefresh * 1000);
		}
	};
